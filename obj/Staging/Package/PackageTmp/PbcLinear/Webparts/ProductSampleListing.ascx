...
<div class="open-grid content-width">
    <section id="sampleOne" runat="server" class="open-grid__item">
    ...
    <section id="sampleTwo" runat="server" class="open-grid__item">
        <div class="open-grid__check">
    ...
    <section id="sampleThree" runat="server" class="open-grid__item">
        <div class="open-grid__check">
    ...
    <section id="sampleFour" runat="server" class="open-grid__item">
        <div class="open-grid__check">
    ...
    <section id="sampleFive" runat="server" class="open-grid__item">
        <div class="open-grid__check">
    ...
    <section id="sampleSix" runat="server" class="open-grid__item">
        <div class="open-grid__check">
    ...
    <section id="sampleSeven" runat="server" class="open-grid__item">
        <div class="open-grid__check">
    ...
    <section id="sampleEight" runat="server" class="open-grid__item">
        <div class="open-grid__check">
    ...
    <section id="sampleNine" runat="server" class="open-grid__item">
        <div class="open-grid__check">
    ...
    <section id="sampleTen" runat="server" class="open-grid__item">
        <div class="open-grid__check">
    ...
    <section id="sampleEleven" runat="server" class="open-grid__item">
        <div class="open-grid__check">
    ...
    <section id="sampleTwelve" runat="server" class="open-grid__item">
        <div class="open-grid__check">
    ...
    <section id="sampleThirteen" runat="server" class="open-grid__item">
        <div class="open-grid__check">
