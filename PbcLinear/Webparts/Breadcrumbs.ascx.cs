...
namespace PbcLinear.Web.PbcLinear.WebParts
{
    public partial class Breadcrumbs : CMSAbstractWebPart
    {
        ...
        {
            get { return ValidationHelper.GetInteger(GetValue("CacheMinutes"), bcElem.CacheMinutes); }
            set
            {
        ...
        {
            get { return ValidationHelper.GetBoolean(GetValue("CheckPermissions"), bcElem.CheckPermissions); }
            set { SetValue("CheckPermissions", value); }
        }
        ...
        public bool CombineWithDefaultCulture
        {
            get
            {
                return ValidationHelper.GetBoolean(GetValue("CombineWithDefaultCulture"),
                    bcElem.CombineWithDefaultCulture);
            }
            set
            {
        ...
        public string CultureCode
        {
            get
            {
                return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("CultureCode"), bcElem.CultureCode),
                    bcElem.CultureCode);
            }
            set
            {
        ...
        public string Path
        {
            get { return DataHelper.GetNotEmpty(GetValue("Path"), bcElem.Path); }
            set
            {
                SetValue("Path", value);
        ...
        {
            get { return ValidationHelper.GetBoolean(GetValue("SelectOnlyPublished"), bcElem.SelectOnlyPublished); }
            set
            {
        ...
        public string SiteName
        {
            get
            {
                return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("SiteName"), bcElem.SiteName),
                    bcElem.SiteName);
            }
            set
            {
        ...
        {
            get { return ValidationHelper.GetBoolean(GetValue("EncodeName"), bcElem.EncodeName); }
            set
            {
        ...
        {
            get { return ValidationHelper.GetString(GetValue("FilterName"), bcElem.FilterName); }
            set
            {
        ...
        {
            get { return ValidationHelper.GetString(GetValue("WhereCondition"), bcElem.WhereCondition); }
            set
            {
        ...
        {
            get { return ValidationHelper.GetBoolean(GetValue("UseRtlBehaviour"), bcElem.UseRtlBehaviour); }
            set
            {
        ...
        public string BreadcrumbSeparator
        {
            ...
            {
                return
                    DataHelper.GetNotEmpty(
                        ValidationHelper.GetString(GetValue("BreadCrumbSeparator"), bcElem.BreadCrumbSeparator),
                        bcElem.BreadCrumbSeparator);
            }
            set
            {
        ...
        public string DefaultPath
        {
            get
            {
                return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("DefaultPath"), bcElem.DefaultPath),
                    bcElem.DefaultPath);
            }
            set
            {
        ...
        public string SelectNodesStartPath
        {
            get
            {
                return
                    DataHelper.GetNotEmpty(
                        ValidationHelper.GetString(GetValue("SelectNodesStartPath"), bcElem.StartingPath),
                        bcElem.StartingPath);
            }
            set
            {
        ...
        {
            get { return ValidationHelper.GetBoolean(GetValue("ShowCurrentItem"), bcElem.ShowCurrentItem); }
            set
            {
        ...
        {
            get { return ValidationHelper.GetBoolean(GetValue("ShowCurrentItemAsLink"), bcElem.ShowCurrentItemAsLink); }
            set
            {
        ...
        public string UrlTarget
        {
            get
            {
                return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("UrlTarget"), bcElem.UrlTarget),
                    bcElem.UrlTarget);
            }
            set
            {
        ...
        public string BreadcrumbSeparatorRTL
        {
            get
            {
                return
                    DataHelper.GetNotEmpty(
                        ValidationHelper.GetString(GetValue("BreadCrumbSeparatorRTL"), bcElem.BreadCrumbSeparatorRTL),
                        bcElem.BreadCrumbSeparatorRTL);
            }
            set
            {
        ...
        public string ClassNames
        {
            get
            {
                return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("Classnames"), bcElem.ClassNames),
                    bcElem.ClassNames);
            }
            set
            {
        ...
        {
            get { return ValidationHelper.GetBoolean(GetValue("ApplyMenuDesign"), bcElem.ApplyMenuDesign); }
            set { SetValue("ApplyMenuDesign", value); }
        }
        ...
        {
            get { return ValidationHelper.GetString(GetValue("ZeroRowsText"), bcElem.ZeroRowsText); }
            set
            {
        ...
        {
            get { return ValidationHelper.GetString(GetValue("Columns"), bcElem.Columns); }
            set
            {
        ...
        {
            get { return base.CacheDependencies; }
            set
            {
        ...
        protected void SetupControl()
        {
            ...
            else
            {
                ...
                bcElem.ShowCurrentItem = true;
                bcElem.ShowCurrentItemAsLink = false;               
                Path = URLHelper.RemoveQuery(RequestContext.CurrentURL);
