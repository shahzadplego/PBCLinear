...
; (function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        'searchID': 'search',
        'nameAttribute': 'name',
        'infowindowTemplatePath': null,
        'listTemplatePath': null,
        'KMLinfowindowTemplatePath': null,
        'KMLlistTemplatePath': null,
        'listTemplateID': null,
        'infowindowTemplateID': null,
        'taxonomyFilters': null,
        'taxonomyFiltersContainer': 'filters-container',
        ...
        taxonomyFiltering: function () {
            ...
            $('.' + this.settings.taxonomyFiltersContainer).on('change.' + pluginName, 'input, select', function (e) {
                ...
                if ($(this).is('input[type="checkbox"]')) {
                    ...
                    filterVal = $(this).val();
                    filterContainer = $(this).closest('.filters').attr('id');
